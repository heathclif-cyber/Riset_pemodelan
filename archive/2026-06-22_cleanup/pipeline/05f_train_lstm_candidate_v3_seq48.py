"""
pipeline/05f_train_lstm_candidate_v3_seq48.py
...
logger = setup_logger("05f_train_lstm_candidate_v3_seq48")
DEVICE = get_lstm_device()

RUN_NAME  = "ic32_lstm_candidate_v3_seq48"
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"  LSTM IC32 CANDIDATE v3 SEQ48 -- {RUN_NAME}")
