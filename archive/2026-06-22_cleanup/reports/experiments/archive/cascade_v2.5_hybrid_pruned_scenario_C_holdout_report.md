# 📊 Holdout Backtest Report: `cascade_v2.5_hybrid_pruned_scenario_C`

**Tanggal Pembuatan**: 2026-06-01 14:34:46 UTC
**Model Run ID**: `cascade_v2.5_hybrid_pruned_scenario_C`
**Periode Pengujian (Temporal OOS)**: `2025-11-01 - 2026-04-01`

> [!NOTE]
> **Ringkasan Portofolio Eksekutif**:
> *   **Total Net Profit**: **$-300.93 USD** (ROI Portofolio: **-14.33%**)
> *   **Rata-rata Win Rate**: **52.48%** | Total Trades: **11,402**
> *   **Rata-rata Max Drawdown (5x)**: **361.10%**
> *   **Risk-Adjusted**: Sharpe: **-0.66** | Sortino: **-1.43** | Calmar: **-0.13** | Profit Factor: **0.96**

## 📈 Performa Scorecard Portofolio

| Metrik Utama | Nilai Portofolio | Catatan |
|:---|:---:|:---|
| **Total Net Profit ($)** | `$-300.93` | Akumulasi keuntungan bersih 5x leverage |
| **Portfolio ROI (%)** | `-14.33%` | ROI berdasarkan kapital portofolio $100/koin |
| **Overall Win Rate** | `52.48%` | Rasio kemenangan rata-rata seluruh aset |
| **Total Trades** | `11,402` | Jumlah total posisi yang dieksekusi |
...
| **Max Drawdown (5x)** | `361.10%` | Rata-rata penurunan terdalam portofolio |
| **Sharpe Ratio** | `-0.66` | Efisiensi profit terhadap volatilitas portofolio |
| **Sortino Ratio** | `-1.43` | Efisiensi profit terhadap downside deviation |
...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **LONG** | 7,119 | 62.4% | 3,447 | 3,672 | 48.42% | -1,604.92 |
| **SHORT** | 4,283 | 37.6% | 2,562 | 1,721 | 59.82% | +1,304.00 |
...
| **Trade Kalah (Losses)** | `$-1.8685` | `-7.47%` |

## 📅 Scorecard Bulanan Portofolio

| Bulan | Total Trades | Wins | Losses | Win Rate | Net PnL ($) |
|:---|:---:|:---:|:---:|:---:|:---:|
| 2025-11 | 2141 | 1111 | 1030 | 51.89% | $-352.13 |
| 2025-12 | 2196 | 1286 | 910 | 58.56% | $+544.65 |
| 2026-01 | 2355 | 1220 | 1135 | 51.80% | $-209.12 |
| 2026-02 | 2197 | 1104 | 1093 | 50.25% | $-328.01 |
...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| `guardian_exit` | 8,235 | 72.2% | 5,726 | 2,509 | 69.53% | $+5,299.98 |
| `sl_hit` | 2,804 | 24.6% | 5 | 2,799 | 0.18% | $-5,711.28 |
...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **1000PEPE** | 54.45% | 292 | 44.4% | 72.4% | `$-33.00` | 351.14% | -1.19 | -2.38 | -0.92 | 0.90 |
| **1000SHIB** | 48.28% | 319 | 42.1% | 65.1% | `$-75.98` | 387.58% | -3.12 | -7.71 | -1.91 | 0.77 |
| **ADA** | 54.77% | 535 | 51.8% | 60.0% | `$+85.89` | 286.94% | 2.51 | 6.82 | 2.92 | 1.18 |
| **ARB** | 53.43% | 569 | 49.9% | 59.8% | `$-36.55` | 491.22% | -1.04 | -2.27 | -0.72 | 0.93 |
...
| **DOGE** | 53.33% | 420 | 48.5% | 64.6% | `$+60.82` | 217.64% | 2.12 | 5.09 | 2.72 | 1.17 |
...
| **POL** | 54.81% | 613 | 55.3% | 53.9% | `$+11.48` | 201.22% | 0.33 | 0.74 | 0.56 | 1.02 |
