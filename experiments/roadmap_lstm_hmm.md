...
### Phase 2 — LSTM Binary Meta-Labeling (Effort: ~2-3 hari)

**Goal**: LSTM sebagai quality scorer — prediksi apakah trade akan profit.
...
**Ukuran sukses**: PnL+LSTM > PnL tanpa LSTM untuk pertama kalinya
