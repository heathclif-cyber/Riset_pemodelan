...
def run_ic_test(
    ...
    # filter label valid + encode ordinal
...
def main():
    ...
    parser.add_argument("--min-standalone", type=float, default=MIN_STANDALONE_IC)
    parser.add_argument("--min-tstat", type=float, default=MIN_TSTAT)
    parser.add_argument("--min-marginal", type=float, default=MIN_MARGINAL_IC)
