"""
pipeline/04_train_lgbm.py — Fase 04: LightGBM Entry Signal Training
...
LGBM adalah primary entry signal generator dalam 2-model cascade:
  STEP 1  04_train_lgbm.py  → LGBM entry signal ← file ini
  STEP 2  05_train_lstm.py  → LSTM confirmation
...
Jalankan:
  ...
  python pipeline/04_train_lgbm.py --run-id my_run
"""
