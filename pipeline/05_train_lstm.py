"""
pipeline/05_train_lstm.py — Fase 05: LSTM Momentum Confirmation Training
...
PERAN DALAM 2-MODEL CASCADE:
  LSTM berfungsi sebagai "soft confirmation" pada STEP 2:
    ...
    STEP 1  04_train_lgbm.py → LGBM entry signal (primary)
    STEP 2  05_train_lstm.py    → LSTM soft adjustment ← file ini
...
_fh = logging.FileHandler(LOG_DIR / "05_train_lstm.log", encoding="utf-8")
...
NON_FEATURE_COLS = {"label", "h4_swing_high", "h4_swing_low", "hmm_regime", "hmm_regime_enc"}  # hmm_regime_enc hardcoded 0, dikecualikan di noD1
