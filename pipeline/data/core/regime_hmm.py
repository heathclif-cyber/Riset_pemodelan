...
def main():
    ...
    # PERINGATAN: blok holdout di bawah ini BUKAN SSOT -- SSOT holdout/live yang benar
    # adalah pipeline/data/core/regime_hmm_holdout.py (fit TANPA btc_h4, predict causal
    # sejak 2026-07-13). Blok ini masih pakai Viterbi + btc_h4 (beda dari SSOT di 2 hal
    # sekaligus) -- peninggalan lama, JANGAN dipakai, cuma dibiarkan supaya tidak pecah
    # kalau ada pemanggil lama. Kalau perlu regenerate regime holdout, pakai
    # `python pipeline/data/run_regime_holdout.py --all`, BUKAN script ini.
