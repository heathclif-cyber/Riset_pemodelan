# 📊 Holdout Backtest Report: `cascade_v2.5_hybrid_accel_scenario_V9`

**Tanggal Pembuatan**: 2026-06-03 20:49:44 UTC
**Model Run ID**: `cascade_v2.5_hybrid_accel_scenario_V9`
**Periode Pengujian (Temporal OOS)**: `2025-11-01 - 2026-04-01`

> [!NOTE]
> **Ringkasan Portofolio Eksekutif**:
> *   **Total Net Profit**: **$+1,560.72 USD** (ROI Portofolio: **+74.32%**)
> *   **Rata-rata Win Rate**: **60.78%** | Total Trades: **2,840**
> *   **Rata-rata Max Drawdown (5x)**: **79.69%**
> *   **Risk-Adjusted**: Sharpe: **4.29** | Sortino: **11.63** | Calmar: **13.21** | Profit Factor: **2.77**

## 📈 Performa Scorecard Portofolio

| Metrik Utama | Nilai Portofolio | Catatan |
|:---|:---:|:---|
| **Total Net Profit ($)** | `$+1,560.72` | Akumulasi keuntungan bersih 5x leverage |
| **Portfolio ROI (%)** | `+74.32%` | ROI berdasarkan kapital portofolio $100/koin |
| **Overall Win Rate** | `60.78%` | Rasio kemenangan rata-rata seluruh aset |
| **Total Trades** | `2,840` | Jumlah total posisi yang dieksekusi |
| **Rata-rata Trade / Bulan** | `27.4` | Rata-rata frekuensi trade bulanan portofolio |
| **Rata-rata Trade / Hari** | `0.90` | Rata-rata frekuensi trade harian portofolio |
| **Max Drawdown (5x)** | `79.69%` | Rata-rata penurunan terdalam portofolio |
| **Sharpe Ratio** | `4.29` | Efisiensi profit terhadap volatilitas portofolio |
| **Sortino Ratio** | `11.63` | Efisiensi profit terhadap downside deviation |
| **Calmar Ratio** | `13.21` | Rasio return tahunan terhadap drawdown |
| **Profit Factor** | `2.77` | Rasio gross profit dibagi gross loss |
...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| **LONG** | 1,404 | 49.4% | 762 | 642 | 54.27% | +398.19 |
| **SHORT** | 1,436 | 50.6% | 959 | 477 | 66.78% | +1,162.54 |

### Rincian Rata-rata Profitabilitas per Trade

| Tipe Trade | PnL Rata-rata ($) | PnL Rata-rata (%) |
|:---|:---:|:---:|
| **Trade Menang (Wins)** | `$+2.0895` | `+8.36%` |
| **Trade Kalah (Losses)** | `$-1.8188` | `-7.28%` |

## 📅 Scorecard Bulanan Portofolio

| Bulan | Total Trades | Wins | Losses | Win Rate | Net PnL ($) |
|:---|:---:|:---:|:---:|:---:|:---:|
| 2025-11 | 572 | 333 | 239 | 58.22% | $+279.06 |
| 2025-12 | 564 | 373 | 191 | 66.13% | $+502.78 |
| 2026-01 | 531 | 343 | 188 | 64.60% | $+437.89 |
| 2026-02 | 555 | 282 | 273 | 50.81% | $-31.69 |
| 2026-03 | 618 | 390 | 228 | 63.11% | $+372.69 |

## 🚪 Distribusi Alasan Keluar Posisi (Exit Reasons)

| Alasan Exit | Jumlah | Persentase | Wins | Losses | Win Rate | PnL Bersih ($) |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| `guardian_exit` | 2,213 | 77.9% | 1,687 | 526 | 76.23% | $+2,710.84 |
| `sl_hit` | 588 | 20.7% | 0 | 588 | 0.00% | $-1,165.60 |
...
| **ADA** | 65.83% | 120 | 62.7% | 68.8% | `$+117.10` | 32.55% | 6.46 | 19.04 | 35.04 | 2.61 |
